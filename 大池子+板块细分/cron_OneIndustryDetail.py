...
sql_sp_LJ = 'select id,J7813,J9913,J2831,J3042,J1909,J3264,J1443,J9408,J4427,J7073,J7073,J9867,J3020,J9780,J4396,J7199,J3393,J3630,J7745,J1419,J3021,J2925,J9797,J6379,J6078,J7192,J7595,J9697,J3288,J2498,J7979,J4726,J1775,J3452,J9692,LastTime from sp_LJ  ; '
...
def savedt():
    ...
    excelFile3 = '{0}/{1}.xlsx'.format(ln, "ODDjs")  # 处理了文件属于当前目录下！
...
def sendmail():
    ...
    try:
        ...
        xlsxpart3 = MIMEApplication(open('{0}/ODDjs.xlsx'.format(ln), 'rb').read())
        xlsxpart3.add_header('Content-Disposition', 'attachment', filename='ODDjs.xlsx')
