...
def savedt():
    ...
    excelFile3 = '{0}/{1}.xlsx'.format(ln, "JS_Mons")  # 处理了文件属于当前目录下！
...
def sendmail():
    ...
    try:
        ...
        xlsxpart3 = MIMEApplication(open('{0}/JS_Mons.xlsx'.format(ln), 'rb').read())
        xlsxpart3.add_header('Content-Disposition', 'attachment', filename='JS_Mons.xlsx')
